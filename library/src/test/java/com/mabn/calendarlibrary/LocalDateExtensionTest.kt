...
internal class LocalDateExtensionTest {
    @Test
    fun `should get remaining dates in month`() {
    ...
    @Test
    fun `should get remaining dates in week`() {
    ...
    @Test
    fun `should get date for the first day of the week (default monday)`() {
    ...
    @Test
    fun `should get date for the first day of the week which is sunday`() {
        val date = LocalDate.of(2022, 9, 21)
